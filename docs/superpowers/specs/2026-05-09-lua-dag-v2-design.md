...
- **NOT a restaking AVS**: không borrow security từ Ethereum/BTC native. Tuy nhiên rev.2 thêm **optional Bitcoin checkpoint** (Babylon-style) như security upgrade khả chọn.
...
2. **Trong mỗi subnet**, một subnet aggregator (rotated by iVRF) thu chữ ký. Khi đủ 2/3 subnet stake, aggregator gọi aggregate operation thành `subnet_aggregate[k]`.
...
Activated khi macro proposer DoS hoặc Mode A timeout sau $T_{\text{macro\_propose}}$:

1. Validator broadcast partial signature qua gossip layer kèm subnet ID.
2. Mỗi node lưu local view các partial sigs đã thấy. Khi đủ stake threshold trong tất cả subnet (hoặc đủ tổng stake), local node tự tạo MacroQC candidate.
3. Validator publish MacroQC candidate đầu tiên thấy → broadcast → consensus convergence trong O(log N) rounds gossip.

Mode B dựa trên kỹ thuật của Long et al. (2019) "Scalable BFT through Aggregated Signature Gossip" — non-interactive, leaderless, chỉ O(log n) messages per node. Đảm bảo liveness ngay cả khi proposer Byzantine, đổi lại latency cao hơn ~2x Mode A.
...
9. Danezis et al., "Narwhal and Tusk: A DAG-based Mempool and Efficient BFT Consensus", EuroSys 2022.
10. Spiegelman et al., "Bullshark: DAG BFT Protocols Made Practical", CCS 2022.
11. Spiegelman et al., "Shoal: Improving DAG-BFT Latency And Robustness", arXiv 2023.
12. Babel et al., "Mysticeti: Low-Latency DAG Consensus with Fast Commit Path", arXiv 2023.
13. Chursin, "Adelie: Detection and prevention of Byzantine behaviour in DAG-based consensus", arXiv 2024.
14. Ladelsky et al., "On Quorum Sizes in DAG-Based BFT Protocols", IEEE ICBC 2025.
15. Qiu et al., "LiDO-DAG: A Framework for Verifying Safety and Liveness of DAG-Based Consensus Protocols", PACMPL 2025.

### 17.3 Data availability

16. Nazirkhanova et al., "Information Dispersal with Provable Retrievability for Rollups (Semi-AVID-PR)", AFT 2022.
17. Hall-Andersen et al., "Foundations of Data Availability Sampling", IACR Commun. Cryptol. 2025.
18. Grundei et al., "From Indexing to Coding: A New Paradigm for Data Availability Sampling", arXiv 2025.
19. Fisch et al., "Permissionless Verifiable Information Dispersal (Data Availability for Bitcoin Rollups)", IEEE S&P 2025.
20. Cohen et al., "Proof of Availability and Retrieval in a Modular Blockchain Architecture", IACR ePrint 2022/2023.

### 17.4 Finality

21. D'Amato et al., "3-Slot-Finality Protocol for Ethereum", arXiv 2024.
22. Saraswat et al., "SoK: Speedy Secure Finality", 2025.
23. Zanolini, "A Simple Single Slot Finality Protocol For Ethereum", IACR ePrint 2023.
24. Tapolcai et al., "Fully Decentralized Collection of Attestations for Single-Slot Finality in Ethereum", IEEE ICDCS 2025.
25. Goroshevsky et al., "Acki Nacki: A Probabilistic Proof-of-Stake Consensus Protocol with Fast Finality", 2024.

### 17.5 Cryptography

26. Esgin et al., "A New Look at Blockchain Leader Election: Simple, Efficient, Sustainable and Post-Quantum (iVRF)", AsiaCCS 2023.
27. Giunta et al., "Unbiasable Verifiable Random Functions", 2024.
28. Drake et al., "Hash-Based Multi-Signatures for Post-Quantum Ethereum", IACR ePrint 2025.
29. Boneh et al., "Compact Multi-Signatures for Smaller Blockchains", 2018.
30. Hofmeier et al., "One For All: Formally Verifying Protocols which use Aggregate Signatures", IEEE CSF 2025.
31. Li et al., "Performance of EdDSA and BLS Signatures in Committee-Based Consensus", 2023.
32. Long et al., "Scalable BFT Consensus Mechanism Through Aggregated Signature Gossip", IEEE ICBC 2019.

### 17.6 PoS security & long-range

33. Gazi et al., "Stake-Bleeding Attacks on Proof-of-Stake Blockchains", CVCBT 2018.
34. Tas et al., "Bitcoin-Enhanced Proof-of-Stake Security: Possibilities and Impossibilities (Babylon)", IEEE S&P 2023.
35. Azouvi et al., "Pikachu: Securing PoS Blockchains from Long-Range Attacks by Checkpointing into Bitcoin PoW", 2022.
36. Azouvi et al., "Winkle: Foiling Long-Range Attacks in Proof-of-Stake Systems", AFT 2020.
37. Mighan et al., "Performance of Ethereum 2.0-Like Consensus Under Single-Slot Finality", IEEE ICC 2024.

### 17.7 MEV resistance

38. Malkhi et al., "Maximal Extractable Value (MEV) Protection on a DAG (Fino)", 2022.
39. Kavousi et al., "BlindPerm: Efficient MEV Mitigation with an Encrypted Mempool and Permutation", IACR ePrint 2023.
40. Yang et al., "SoK: MEV Countermeasures: Theory and Practice", arXiv 2022.
41. Nasrulin et al., "LO: An Accountable Mempool for MEV Resistance", Middleware 2023.

### 17.8 Operational

42. Ethereum.org, "Consensus Mechanisms / Sync Committees / Weak Subjectivity", 2024–2026.
